...
export const Layout = () => {
    const children = 'It’s the perfect place to go to declutter or discover items that will breathe new life into your space. Letting go has never felt so good – it’s almost as good as finding your new favorite thing. And we’re here to help.\n' +
        '\n' +
